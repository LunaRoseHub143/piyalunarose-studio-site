          ...
          <div className="min-h-screen bg-[#0a051a] font-sans text-stone-300 selection:bg-indigo-500/30 selection:text-white">
            ...
            <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-[#0a051a]/80 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
              <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-8">
                  ...
                  <a
                    href="mailto:Hello@lunarosedhealinghub.com?subject=Project Inquiry"
                    className="px-5 py-2.5 bg-white text-[#0a051a] text-sm font-semibold rounded-lg hover:bg-indigo-50 transition-all hover:scale-105 active:scale-95"
                  >
                    Request a Quote
                  </a>
                </div>
            ...
            <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden z-10">
              <div className="max-w-4xl mx-auto text-center relative z-10">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-xs font-bold tracking-widest uppercase mb-6 animate-pulse">
                  <Zap className="w-3 h-3 text-indigo-400" />
                  <span>Systems • Clarity • Resilience</span>
                </div>

                <h1 className="text-4xl md:text-7xl lg:text-8xl font-serif font-bold text-white leading-[1.05] mb-8 tracking-tight">
                  ...
                  <span className="block text-indigo-400/40 italic font-normal mt-2"> & embodied practices.</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                  <a
                    href="mailto:Hello@lunarosedhealinghub.com?subject=Project Inquiry"
                    className="w-full sm:w-auto px-8 py-4 bg-white text-[#0a051a] font-bold rounded-xl hover:bg-indigo-50 transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] flex items-center justify-center gap-2 group"
                  >
                    Request a Quote <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                  </a>
                  <button
                    onClick={() => scrollToSection('work')}
                    className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 text-white font-medium rounded-xl hover:bg-white/10 hover:border-white/30 transition-all backdrop-blur-sm"
                  >
                    View Selected Work
                  </button>
                </div>
